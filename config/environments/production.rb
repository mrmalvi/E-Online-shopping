...
Rails.application.configure do
  ...
  config.active_record.encryption.key = Rails.application.secrets.active_record_encryption_key
  ...
  # config.active_job.queue_name_prefix = "E_Online_Shopping_production"
